  ...
  class Server < Roda
    ...
    route do |r|
      ...
      r.is ['', true] do
        ...
        r.post do
          ...
          storage.set_upload_prefix(request.headers["Upload-Prefix"])
    ...
    def handle_cors!
      ...
      if request.options?
        ...
        response.headers["Access-Control-Allow-Headers"] = "Authorization, Origin, X-Requested-With, X-Request-ID, X-HTTP-Method-Override, Content-Type, Upload-Length, Upload-Offset, Tus-Resumable, Upload-Metadata, Upload-Defer-Length, Upload-Concat, Upload-Prefix"
